      ...
      <div className="relative z-10 w-full max-w-3xl mx-auto flex flex-col items-center">
        ...
        >
          <div className="flex items-center flex-1 w-full pl-4 py-3 sm:py-0">
            ...
            <input
              ...
              className="w-full bg-transparent border-none outline-none text-white placeholder-gray-600 px-3 text-sm md:text-base"
              required
            />
          </div>
          <button
            type="submit"
            className="w-full sm:w-auto mt-2 sm:mt-0 px-8 py-3.5 sm:py-3 rounded-xl sm:rounded-full font-bold text-black bg-emerald-500 hover:bg-emerald-400 transition-all shadow-[0_0_15px_rgba(16,185,129,0.3)] hover:shadow-[0_0_25px_rgba(16,185,129,0.5)] active:scale-95 whitespace-nowrap"
          >
            Get Free Trial
          </button>
        </form>
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <a
              href="#"
              className="w-12 h-12 rounded-full bg-[#111] border border-white/5 flex items-center justify-center hover:bg-emerald-500/10 hover:border-emerald-500/30 hover:text-emerald-400 text-gray-400 transition-all duration-300 shadow-lg hover:-translate-y-1"
            >
